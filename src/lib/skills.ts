...
export const skills: Skill[] = [
  {
    slug: "creative-play", figureSlug: "pendleton-ward", title: "Creative play",
    tagline: "Turn creative pressure into a small experiment.",
    whenToUse: "A creative project feels intimidating or joyless.",
    source: "Inside the Fun Factory, Max Eddy, The Mary Sue (2012)",
    sourceAnchor: "Writing for the team's own amusement and learning across departments",
    command: "/pendleton-ward:creative-play", themes: ["building", "starting"],
    problemHint: "I want to make something, but I have made it feel like homework.",
  },
  {
    slug: "practice-kindness", figureSlug: "pendleton-ward", title: "Practice kindness",
    tagline: "Find one kind action you can actually take.",
    whenToUse: "Self-judgment is crowding out a manageable next step.",
    source: "The Midnight Gospel interview, Rollin Bishop, ComicBook (2020)",
    sourceAnchor: "Choosing conversations about practicing kindness",
    command: "/pendleton-ward:practice-kindness", themes: ["self", "meaning"],
    problemHint: "I am putting too much pressure on myself to get everything right.",
  },
  // ───── Rockefeller ─────
  {
    slug: "rockefeller",
  ...
  },
  {
    ...
    title: "Channel Paul Graham",
    tagline: "Get out of startup theater and back to users, product, maker time, and the smallest test that can teach you something real.",
    whenToUse: "Use when choosing a startup idea, testing demand, cutting a first version, protecting maker time, deciding whether to raise, or choosing ambitious work over prestigious work.",
    source: "Paul Graham's essays at paulgraham.com",
    command: "/paul-graham:paul-graham",
    umbrella: true,
    themes: ["starting", "building", "thinking", "focus"],
    problemHint: "I'm doing a lot around the project but I can't tell whether I'm working on the real thing or performing the role.",
  },
  {
    slug: "do-things-that-dont-scale",
    figureSlug: "paul-graham",
    title: "Do Things That Don't Scale",
    tagline: "Replace abstract growth planning with manual recruiting, close observation, and an unusually attentive first-user experience.",
    whenToUse: "Use when a product has few users, the acquisition plan is vague, or the team wants to automate before it understands what users value.",
    source: "Do Things that Don't Scale by Paul Graham (2013)",
    sourceAnchor: "Manual user recruitment and the fragile early product",
    command: "/paul-graham:do-things-that-dont-scale",
    themes: ["starting", "growth", "building"],
    problemHint: "We have a product but almost no users, and I keep reaching for scalable marketing before anyone cares.",
  },
  {
    slug: "default-alive",
    figureSlug: "paul-graham",
    title: "Default Alive",
    tagline: "Use current cash, burn, and growth to determine whether the company reaches profitability before the bank balance reaches zero.",
    whenToUse: "Use when runway is becoming a concern, fundraising is being treated as inevitable, or founders have avoided doing the survival arithmetic.",
    source: "Default Alive or Default Dead? by Paul Graham (2015)",
    command: "/paul-graham:default-alive",
    themes: ["money", "risk", "deciding"],
    problemHint: "I know our runway, but I don't know whether our current trajectory actually reaches profitability in time.",
  },
  {
    slug: "maker-schedule",
    figureSlug: "paul-graham",
    title: "Protect the Maker Schedule",
    tagline: "Cluster coordination and recover the uninterrupted blocks required to hold a large creative problem in your head.",
    whenToUse: "Use when meetings fragment a builder's day, important creative work keeps slipping, or a manager schedule is being imposed on makers.",
    source: "Maker's Schedule, Manager's Schedule by Paul Graham (2009)",
    command: "/paul-graham:maker-schedule",
    themes: ["focus", "building", "leading"],
    problemHint: "My calendar is full and I end every week having coordinated everything except the work only I can make.",
  },
  {
    slug: "great-work-project",
    figureSlug: "paul-graham",
    title: "Find the Great-Work Project",
    tagline: "Move from vague ambition to a field, its frontier, an interesting gap, and one project that creates feedback this week.",
    whenToUse: "Use when choosing what to work on, changing fields, feeling trapped by prestige, or trying to turn curiosity into a serious project.",
    source: "How to Do Great Work by Paul Graham (2023)",
    command: "/paul-graham:great-work-project",
    themes: ["meaning", "starting", "thinking"],
    problemHint: "I want to do important work, but the goal is so abstract that it never becomes a project.",
  },
];
