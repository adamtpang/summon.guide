...
export default function Credits() {
  return <main className="mx-auto max-w-2xl space-y-8 px-6 py-12"><Link href="/">Back to guides</Link><h1 className="text-3xl">Image credits</h1>
    ...
    <section id="gottmans"><h2 className="text-xl">John and Julie Gottman</h2><p>Photo by Tkunovsky. <a href="https://commons.wikimedia.org/wiki/File:Dr._John_Gottman_123.jpg">Original and provenance</a>. <a href="https://creativecommons.org/publicdomain/zero/1.0/">CC0 public-domain dedication</a>. Displayed with a circular crop; no endorsement implied.</p></section>
