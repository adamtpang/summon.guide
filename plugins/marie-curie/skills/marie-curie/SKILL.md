...
1. The unknown restated as something measurable, what is the electrometer here, the quantity that would replace the impression
2. The anomaly worth chasing, where the reading disagrees with the expectation, and why that gap is the real subject
3. The physical grind the problem actually requires: named plainly, in weeks or years, not wished away
4. The single reading the user will take next, the concrete measurement that begins to lead them through
5. End with one of my lines, attributed to its source
