...
### Lock 1: Compensate competitively
...
For the user:
- Who in the organization is making decisions where corruption would be worth it (vendor selection, hiring, promotion, large purchases, financial reporting)?
- Are they paid enough that the marginal benefit of taking is small relative to what they have to lose?
- Where is the gap between what these roles pay and what equivalent roles pay outside? That gap is your corruption budget.
...
### Lock 2: Prosecute without exception
...
For the user:
- What is the equivalent of the CPIB in your organization? An independent ethics function? An audit committee? Anonymous reporting that cannot be retaliated against?
- Does it report to the top, bypassing political interference?
- When the rule was last broken, was the consequence applied without exception, or was an exception made because the person was important?
- The first time you make an exception, you have re-priced corruption in your culture. Track this carefully.
...
- Are people learning from each others' fates, or are the fates hidden?
...
- Where in the org are decisions made that would be worth corrupting?
- Are those decision-makers paid enough that taking is irrational?
- Is there an independent enforcement mechanism that reports to the top?
- Has any exception been made in the last year that re-priced the cost of bending rules?
- Are consequences visible enough that others update their behavior from them?
- Are small infractions enforced, not just large ones?

## Anti-patterns

- Treating incorruptibility as a values issue ("we hire good people") instead of an incentive issue.
- Paying competitively but not enforcing. Generates entitled bad actors.
- Enforcing harshly but not paying competitively. Generates underpaid resentment.
- Making "one exception" because the person is irreplaceable. They become more irreplaceable.
- Hiding consequences to "protect privacy." This kills the information mechanism.
- Tolerating small corruptions because they are "not worth a fight." That is exactly where culture forms.

## Output

Produce a one-page Incorruptibility Audit:
1. The decision points in the organization where corruption would be worth it
