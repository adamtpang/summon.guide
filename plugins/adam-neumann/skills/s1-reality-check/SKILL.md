...
1. The hostile-reader packet, list of documents and metrics to assemble
2. The reading, what would the worst article say, and which sentences would be technically true?
3. The kill-shot finding, the single thing that would collapse the story
4. The fix plan, three concrete actions in the next 90 days
5. If the evidence cannot catch up: the revised story your numbers can survive, drafted plainly
