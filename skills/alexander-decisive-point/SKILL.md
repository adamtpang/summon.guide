...
### 1. List every front you are currently fighting
...
### 2. Identify the actual decisive point
...
- If we won at this front and lost at every other, would we win the campaign?
- If we won everywhere except this front, would we still lose the campaign?
- Where is the enemy weakest at the seam between two of their strengths?
...
### 3. Concentrate force ruthlessly
...
- Can it be paused entirely?
- Can it be put on minimum maintenance staffing?
- Can it be delegated to one person who can hold the line without progress?
- What is the cost of letting this front rot for 90 days while you crack the decisive one?

### 4. Strike before they can react
...
- What is the decisive point, named in one sentence?
- What fraction of total resource is on it today, and what fraction will be in 30 days?
- What fronts are being put on minimum staffing or paused?
- What is the time-to-strike, and is it faster than the competitor's time-to-mobilize?
- What diversion has already shown up this week, and how was it handled?

## Anti-patterns

- Picking the easiest front and calling it decisive because it is winnable.
- Picking three "decisive points" because you cannot bear to pause two of them.
- Concentrating force but moving slowly. Concentration without speed gets surrounded.
- Letting Parmenion's messenger pull you off the line. Diversions are designed to feel urgent.
- Confusing the obvious enemy strength with the decisive point. You attack the seam, not the wall.

## Output

Produce a one-page decisive-point plan:
1. Every current front, listed
2. The single decisive point — the one where winning makes the rest moot
3. The concentration plan — what fraction of resource moves where, and what gets paused
4. The time-to-strike target and the first move this week
5. The likely diversion that will arrive, and the pre-committed response to it
