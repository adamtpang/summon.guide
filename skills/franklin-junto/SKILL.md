...
### Step 3: Fixed cadence, fixed location
...
- Hath any citizen in your knowledge failed in business lately, and what have you heard of the cause?
- Have you lately heard of any citizen's thriving well, and by what means?
- Have you lately observed any defect in the laws of your country, of which it would be proper to move the legislature for an amendment?
...
### Step 5: One inquiry per quarter
...
After 90 days, ask:
- Has every member surfaced a real "weighty affair" the group helped with?
- Has the group produced one tangible artifact (library, document, tool, event)?
- Are at least 2 members closer to each other than to the rest? (Sub-coalitions are healthy.)
- Has anyone been quietly carried by the group without contributing? Address it.

## Anti-patterns

- Mixing this with a casual social circle. The Junto is a contract.
- Letting it drift to one extrovert hosting and 11 attending. Rotate facilitator.
- No accountability for misses. Two no-shows without notice = polite exit.
- Recruiting on prestige. Curiosity beats credentials every time.
- Skipping the "weighty affair" question to "get back to dinner."
