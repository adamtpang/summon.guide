---
name: franklin-thirteen-virtues
...
After 13 weeks, ask:
- Which virtue's marks decreased? That is real progress.
- Which virtue still bleeds dots? That is the diagnostic for cycle 2.
- Which virtue feels different even if the dots are the same? That is identity shifting.
- What event last week would have been a failure mark before, but was not?

## Anti-patterns

- Picking 13 virtues that all feel comfortable. The list should make you wince when you read it.
- Tracking all 13 simultaneously instead of focusing on one. Attention is the active ingredient.
- Skipping the failure marks because they feel bad. The marks ARE the practice.
- Quitting after one cycle. Franklin ran this for decades.

## Output

Produce a personalized 13-virtue system:
1. The user's 13 virtues (modified Franklin list, or fully custom)
